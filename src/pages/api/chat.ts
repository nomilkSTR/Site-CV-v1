...
- Référent Cotation (Alcopa Auction, depuis 05/2026) : Cotation de véhicules VO/VU avec gestion de comptes clients attitrés en tant qu'interlocuteur direct. Gestion des non-conformités et négociation des révisions d'engagement avec les apporteurs.
- Analyst Pricer (Alcopa Auction, 01/2023 – 05/2026) : Création d'un Assistant de Cotation Intelligent (Fullstack & IA) utilisant Python, JS, Supabase et Gemini pour automatiser la lecture des fiches et l'analyse de marché. Gain de 40% de productivité. Suivi des tendances de prix VO et négociation des engagements avec les apporteurs. 43 000 dossiers/an.
...
- Directeur Général (Les Sunneliers SAS, 2018-2021) : Co-fondateur de la startup Niu & You. Direction complète avec autonomie décisionnelle totale. Pilotage stratégique & financier, maîtrise opérationnelle & commerciale (supply chain, réseau de distribution, rentabilité). Innovation de modèle & ingénierie fiscale : création d'une ONG (Octop'Us) intégrée au business model via un système de mécénat optimisant la fiscalité tout en finançant des actions environnementales concrètes ("1 tube vendu = 1m² de plage nettoyé"). Gouvernance conjointe SAS/ONG.
...
- Automobile : J'ai géré l'achat/revente et la mécanique de 34 véhicules. Je suis membre de l'Enthousiast'Club Jaguar Alsace. Voici la liste détaillée des véhicules que j'ai possédés, avec leurs marques :
  ...
  - Renault : Laguna 1 1.9 dTi, Laguna 2 2.0 Initiale, Grand Espace 4 2.0t, Clio 3 2.0 140, Clio 1.5 dCi 105, Laguna Coupé 2.0 dCi 175, Espace 4 2.0 dCi 175 (x2), Laguna 3 2.0 140, Laguna 3 Estate 2.0 dCi.
  - Saab : 9-5 Aero.
