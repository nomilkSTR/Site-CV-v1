...
- Référent Cotation (Alcopa Auction, depuis 2023) : Cotation de véhicules VO/VU avec gestion de comptes clients attitrés en tant qu'interlocuteur direct. Gestion des non-conformités et négociation des révisions d'engagement avec les apporteurs. J'ai aussi créé un Assistant de Cotation Intelligent (Fullstack & IA) utilisant Python, JS, Supabase et Gemini pour automatiser la lecture des fiches et l'analyse de marché.
